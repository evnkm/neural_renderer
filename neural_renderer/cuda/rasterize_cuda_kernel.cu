...
std::vector<at::Tensor> forward_face_index_map_cuda(
    ...
    AT_DISPATCH_FLOATING_TYPES(faces.options(), "forward_face_index_map_cuda_1", ([&] {
    ...
    AT_DISPATCH_FLOATING_TYPES(faces.options(), "forward_face_index_map_cuda_2", ([&] {
...
std::vector<at::Tensor> forward_texture_sampling_cuda( at::Tensor faces,
    ...
    AT_DISPATCH_FLOATING_TYPES(faces.options(), "forward_texture_sampling_cuda", ([&] {
...
at::Tensor backward_pixel_map_cuda(
    ...
    AT_DISPATCH_FLOATING_TYPES(faces.options(), "backward_pixel_map_cuda", ([&] {
...
at::Tensor backward_textures_cuda(
    ...
    AT_DISPATCH_FLOATING_TYPES(sampling_weight_map.options(), "backward_textures_cuda", ([&] {
...
at::Tensor backward_depth_map_cuda(
    ...
    AT_DISPATCH_FLOATING_TYPES(faces.options(), "backward_depth_map_cuda", ([&] {
